...
namespace MStopwatch.Models
{
    public class Stopwatch:BindableBase
    {
        ...
        {
            get => this.startTime.ToLocalTime();
        ...
        private ReadOnlyObservableCollection<LapTime> _items;
        public ReadOnlyObservableCollection<LapTime> Items =>
            _items ?? (_items = new ReadOnlyObservableCollection<LapTime>(this.ItemsSource));
